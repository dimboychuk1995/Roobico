...
**VIN-скан готов** (2026-09-01): кнопка «Scan VIN» на экране нового WO
(и иконка на форме юнита) — expo-camera читает VIN-баркод (Code 39/128,
DataMatrix, QR, PDF417) живьём: навёл — подхватилось, без кнопок. Резолв —
